...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>HOW TO PLAY</div><br><p>Ziel von Hextris ist es, die Blöcke daran zu hindern, das Innere des äußeren grauen Sechsecks zu verlassen.</p><p>" + (settings.platform != 'mobile' ? 'Drücken Sie die rechte und linke Pfeiltaste' : 'Tippen Sie auf die linke und rechte Seite des Bildschirms') + " um das Sechseck zu drehen." + (settings.platform != 'mobile' ? ' Drücken Sie den Pfeil nach unten, um das Fallen des Blocks zu beschleunigen.': '') + " </p><p>Räumen Sie Blöcke ab und erhalten Sie Punkte, indem Sie 3 oder mehr Blöcke derselben Farbe berühren lassen.</p><p>Die verbleibende Zeit bis zur Beendigung der Combo-Serie wird angezeigt durch <span style='color:#f1c40f;'>die</span> <span style='color:#e74c3c'>farbigen</span> <span style='color:#3498db'>Linien</span> <span style='color:#2ecc71'>auf</span> dem äußeren Sechseck.</p> <p id = 'afterhr'></p> <a href='http://loganengstrom.com' target='_blank'></a> <a href='http://github.com/garrettdreyfus' target='_blank'></a><br><a href = 'https://itunes.apple.com/us/app/id903769553?mt=8' target='_blank'></a> <a href ='https://play.google.com/store/apps/details?id=com.hextris.hextris' target='_blank'></a><a href ='http://hextris.github.io/' target='_blank'></a>");
	if (gameState == 1) {
		pause();
	}
